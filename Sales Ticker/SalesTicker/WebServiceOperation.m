...
-(void)WebServiceOperation
{
   ...
   NSUserDefaults *userNamedefault = [NSUserDefaults standardUserDefaults];
    ...
    NSString *urlString = [NSString stringWithFormat:@"http://test1.unitedcarexchange.com/CarService/ServiceMobile.svc/SalesAgentLogin/%@/%@/%@",getUserName,getPassWord,getCenterCode];
