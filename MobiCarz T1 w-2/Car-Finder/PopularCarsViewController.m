...
-(void)showZipInUpdateZipLabel:(NSString *)zipValue
{
    ...
    {
        [self.rightBarbutton setTitle:[NSString stringWithFormat:@" %@ ",zipValue]];
        zipStrToDisplyAccessibilityLabel=[NSString stringWithFormat:@" %@ ",zipValue];
    }
...
-(UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (self.arrayOfPopularCarsCellInfoObjects.count>0)
    {
        ...
        if([[pcCellInfo car] carid])
        {
            ...
            [cell.yearLabel setTextColor:[UIColor blackColor]];
            ...
            [cell.price setTextColor:[UIColor colorWithRed:216.0f/255.0f green:74.0f/255.0f blue:73.0f/255.0f alpha:1.0f]];
            
            cell.makeModel.text=[self combinedStr:pcCellInfo.car.make model:pcCellInfo.car.model];
            [cell.makeModel setTextColor:[UIColor blackColor]];
...
-(void)checkZipCodeNotifMethod:(NSNotification *)notif
{
    ...
    else
    {
        ...
        [self.rightBarbutton setTitle:[NSString stringWithFormat:@" %@",self.zipStr]];
        NSString *zipStrToDisplyAccessibilityLabel=[NSString stringWithFormat:@"%@",self.zipStr];
        self.rightBarbutton.accessibilityLabel=zipStrToDisplyAccessibilityLabel;
