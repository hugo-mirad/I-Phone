...
- (void)viewDidLoad
{
    ...
    UIBarButtonItem *moreButton=[[UIBarButtonItem alloc] initWithTitle:@"More" style:UIBarButtonItemStyleDone target:self action:@selector(moreButtonTapped:)];
    self.navigationItem.leftBarButtonItem=moreButton;
    
//    [[UIBarButtonItem appearanceWhenContainedIn:[UINavigationBar class], nil] setTitleTextAttributes:[NSDictionary dictionaryWithObjectsAndKeys:[UIColor colorWithRed:0.0f/255 green:122.0f/255 blue:255.0f/255 alpha:1.0], UITextAttributeTextColor,nil] forState:UIControlStateNormal];
