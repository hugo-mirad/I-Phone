...
- (id)initWithCoder:(NSCoder *)aDecoder
{
    ...
    if (self) {
        ...
        NSLayoutConstraint *_viewCarsBtnConstraint=[NSLayoutConstraint constraintWithItem:_viewCarsBtn attribute:NSLayoutAttributeTrailing relatedBy:NSLayoutRelationEqual toItem:self.contentView attribute:NSLayoutAttributeTrailing multiplier:1 constant:-70];
        ...
        _viewCarsBtnConstraint=[NSLayoutConstraint constraintWithItem:_viewCarsBtn attribute:NSLayoutAttributeWidth relatedBy:NSLayoutRelationEqual toItem:nil attribute:NSLayoutAttributeWidth multiplier:1 constant:32];
        [self.contentView addConstraint:_viewCarsBtnConstraint];
        
        _viewCarsBtnConstraint=[NSLayoutConstraint constraintWithItem:_viewCarsBtn attribute:NSLayoutAttributeHeight relatedBy:NSLayoutRelationEqual toItem:nil attribute:NSLayoutAttributeHeight multiplier:1 constant:32];
        [self.contentView addConstraint:_viewCarsBtnConstraint];
