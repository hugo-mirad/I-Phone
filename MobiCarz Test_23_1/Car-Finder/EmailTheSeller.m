...
#warning Test with working time email the seller
    
    NSLog(@"buyerEmail--%@,buyerPhone--%@,ToEmail--%@",buyerEmail,buyerPhone,[self.carRecordFromDetailView sellerEmail]);
    ...
    NSArray *keys=[NSArray arrayWithObjects:@"BuyerEmail",@"BuyerCity",@"BuyerPhone",@"BuyerFirstName",@"BuyerLastName",@"BuyerComments",@"IpAddress",@"Sellerphone",@"Sellerprice",@"Carid",@"sYear",@"Make",@"Model",@"price",@"ToEmail",@"AuthenticationID",@"CustomerID",@"BrandID", nil];
  
    
    
    NSArray *values=[NSArray arrayWithObjects:buyerEmail,buyerCity,buyerPhone,buyerFirstName,buyerLastName,buyerComments,ipAddress,sellerphone,sellerprice,carid,sYear,make,model,price,[self.carRecordFromDetailView sellerEmail], @"ds3lkDFD1F5fFGnf2daFs45REsd6re54yb0sc654",retrieveduuid,brandID,nil];
    ...
    [Client postPath:@"MobileService/GenericCarService.asmx/GenericSaveBuyerRequestMobile" parameters:parameters success:^(AFHTTPRequestOperation *operation, id responseObject) {
