...
- (void)registerNewUserWithFname:(NSString *)name phone:(NSString *)phone email:(NSString *)email
{
    ...
    NSString *newRegistrationServiceStr=[NSString stringWithFormat:@"http://test1.unitedcarexchange.com/MobileService/GenericServices.svc/GenericSendMobileRegistrationRequest/%@/%@/%@/ds3lkDFD1F5fFGnf2daFs45REsd6re54yb0sc654/%@/%@",name,phone,email,retrieveduuid,brandID] ; //]@"din9030231534",@"dinesh"];
    ...
    [operation setCompletionBlockWithSuccess:^(AFHTTPRequestOperation *operation, id responseObject) {
        ...
        if(error2==nil)
        {
            ...
            BOOL newRegistrationResult=[[wholeResult objectForKey:@"GenericSendMobileRegistrationRequestResult"] boolValue];
