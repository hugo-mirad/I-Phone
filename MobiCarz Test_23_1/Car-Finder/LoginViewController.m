...
- (void)viewDidLoad
{
   ...
   self.passwordTextField.text=@"123456";
    ...
    button = (UIButton *)[self.view viewWithTag:88];
...
-(void)checkLoginStatus
{
    ...
    NSString *loginServiceStr=[NSString stringWithFormat:@"http://test1.unitedcarexchange.com/MobileService/GenericServices.svc/GenericPerformLoginMobile/%@/%@/ds3lkDFD1F5fFGnf2daFs45REsd6re54yb0sc654/%@/%@", uName,uPassword,retrieveduuid,brandID] ; //]@"din9030231534",@"dinesh"];
    ...
    [operation setCompletionBlockWithSuccess:^(AFHTTPRequestOperation *operation, id responseObject) {
        ...
        if(error2==nil)
        {
            ...
            NSArray *loginResultArray=[wholeResult objectForKey:@"GenericPerformLoginMobileResult"];
...
-(void)registerInfoServiceImplemenation
{
    ...
    NSString *urlString=[NSString stringWithFormat:@"http://test1.unitedcarexchange.com/MobileService/GenericServices.svc/GenericGetUserRegistrationDetailsByID/%@/ds3lkDFD1F5fFGnf2daFs45REsd6re54yb0sc654/%@/%@/%@",uid,retrieveduuid,sessionID,brandID];
    ...
    [operation setCompletionBlockWithSuccess:^(AFHTTPRequestOperation *operation, id responseObject)
     {
         ...
         if(error2==nil)
         {
             ...
             NSArray *regInfoArray = [wholeResult objectForKey:@"GenericGetUserRegistrationDetailsByIDResult"];
...
# warning Modified New web service_17/06/2014 FindCarID(gallery)
    ...
    NSString *brandID = @"2";
    NSString *urlString=[NSString stringWithFormat:@"http://test1.unitedcarexchange.com/MobileService/GenericServices.svc/GenericFindCarID/%@/ds3lkDFD1F5fFGnf2daFs45REsd6re54yb0sc654/%@/%@",carId,retrieveduuid,brandID];
    ...
    [operation setCompletionBlockWithSuccess:^(AFHTTPRequestOperation *operation, id responseObject)
     {
         ...
         if(error2==nil)
         {
             ...
             NSArray *carIDResultArray = [wholeResult objectForKey:@"GenericFindCarIDResult"];
