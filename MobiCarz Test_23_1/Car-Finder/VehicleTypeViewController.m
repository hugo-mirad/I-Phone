...
//        self.navigationItem.leftBarButtonItem=button;
    ...
    bodyStyleLabel.frame=CGRectMake(10, 208, 85, 30);
    bodyStyleLabel.backgroundColor=[UIColor clearColor];
    bodyStyleLabel.text=@"Body Style :";
    bodyStyleLabel.textColor=[UIColor blackColor];
...
//    self.stylePicker.frame=CGRectMake(150, 130, 220, 180);
    ...
    [self.view addConstraints:[NSLayoutConstraint constraintsWithVisualFormat:@"V:|[vehicleTypeScrollView]|" options:0 metrics:0 views:viewsDict]];
        ...
        [self.view addConstraints:[NSLayoutConstraint constraintsWithVisualFormat:@"V:|-64-[vehicleTypeScrollView]|" options:0 metrics:0 views:viewsDict]];
...
- (void)callWebServiceToSaveData
{
    ...
    AFHTTPClient * Client = [[AFHTTPClient alloc] initWithBaseURL:[NSURL URLWithString:@"http://test1.unitedcarexchange.com/"]];
    ...
    NSArray *keys=[NSArray arrayWithObjects:@"UID",@"Year",@"ExteriorColor",@"InteriorColor",@"Transmission",@"DriveTrain",@"NumberOfDoors",@"MakeModelID",@"BodyTypeID",@"CarID",@"Price",@"Mileage",@"VIN",@"NumberOfCylinder",@"FueltypeID",@"zip",@"City",@"Description",@"VehicleCondition",@"Title",@"StateID",@"AuthenticationID",@"CustomerID",@"SessionID",@"BrandID", nil];
    NSArray *values=[NSArray arrayWithObjects:[self.carReceived uid],year,[self.carReceived exteriorColor],[self.carReceived interiorColor],[self.carReceived transmission],[self.carReceived driveTrain],[self.carReceived numberOfDoors],[self.carReceived modelID],self.bodyStyleIdSelected,carid,price,mileage,[self.carReceived vin],[self.carReceived engineCylinders],[self.carReceived fuelTypeId],[self.carReceived zipCode],[self.carReceived city],[self.carReceived extraDescription],[self.carReceived ConditionDescription],[self.carReceived title],[self.carReceived stateID],@"ds3lkDFD1F5fFGnf2daFs45REsd6re54yb0sc654",retrieveduuid,sessionID,brandID, nil];
    ...
    [Client postPath:@"MobileService/GenericCarService.asmx/UpdateCarDetails" parameters:parameters success:^(AFHTTPRequestOperation *operation, id responseObject) {
