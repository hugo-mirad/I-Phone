...
# warning Modified New web service_17/06/2014 FindCarID(gallery)
    ...
    NSString *brandID = @"2";
    NSString *webServiceUrl=[NSString stringWithFormat:@"http://test1.unitedcarexchange.com/MobileService/GenericServices.svc/GenericFindCarID/%d/ds3lkDFD1F5fFGnf2daFs45REsd6re54yb0sc654/%@/%@",someCarId,retrieveduuid,brandID];
