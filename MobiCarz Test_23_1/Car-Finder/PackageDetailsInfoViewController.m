...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (indexPath.section==0) {
        ...
        [CommonMethods createTwoTextLabel:label firstText:@"Package Name:" secondText:fieldVal firstTextColor:[UIColor blackColor] secondTextColor:[UIColor blackColor]];
        ...
        label=[[UILabel alloc] initWithFrame:CGRectMake(10.0f, y, lWidth, 20.0f)];
        label.textAlignment=NSTextAlignmentLeft;
        [CommonMethods createTwoTextLabel:label firstText:@"Date of Purchase:" secondText:fieldVal firstTextColor:[UIColor blackColor] secondTextColor:[UIColor blackColor]];
        label.backgroundColor=[UIColor clearColor];
        ...
        label=[[UILabel alloc] initWithFrame:CGRectMake(10.0f, y, lWidth, 20.0f)];
        label.textAlignment=NSTextAlignmentLeft;
        [CommonMethods createTwoTextLabel:label firstText:@"Validity:" secondText:fieldVal firstTextColor:[UIColor blackColor] secondTextColor:[UIColor blackColor]];
        label.backgroundColor=[UIColor clearColor];
        ...
        label=[[UILabel alloc] initWithFrame:CGRectMake(10.0f, y, lWidth, 20.0f)];
        label.textAlignment=NSTextAlignmentLeft;
        [CommonMethods createTwoTextLabel:label firstText:@"# of Posted Cars:" secondText:fieldVal firstTextColor:[UIColor blackColor] secondTextColor:[UIColor blackColor]];
        label.backgroundColor=[UIColor clearColor];
        ...
        if ([[self.packageDetailsDict objectForKey:@"_CarsCount"] integerValue] < [[self.packageDetailsDict objectForKey:@"_MaxCars"] integerValue]) {
            ...
            [addACar setTitleColor:[UIColor colorWithRed:216.0f/255.0f green:74.0f/255.0f blue:73.0f/255.0f alpha:1.0f] forState:UIControlStateNormal];
            
           //Button with 0 border so it's shape like image shape
            addACar.layer.shadowRadius = 1.0f;
        ...
        label=[[UILabel alloc] initWithFrame:CGRectMake(10.0f, y, lWidth, 20.0f)];
        label.textAlignment=NSTextAlignmentLeft;
        [CommonMethods createTwoTextLabel:label firstText:@"# of Max Cars:" secondText:fieldVal firstTextColor:[UIColor blackColor] secondTextColor:[UIColor blackColor]];
        label.backgroundColor=[UIColor clearColor];
    ...
    cell.yearMakeModelLabel.textColor =  [UIColor blackColor];
    //price formatter
