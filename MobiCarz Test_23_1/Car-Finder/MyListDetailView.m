...
#warning Modified New web service_16/06/2014 GenericSaveCallRequestMobile hold for buyer phone number
    
  NSString *brandID = @"2";
    callServiceStr=[NSString stringWithFormat:@"http://test1.unitedcarexchange.com/MobileService/GenericServices.svc/GenericSaveCallRequestMobile/0/%d/%@/ds3lkDFD1F5fFGnf2daFs45REsd6re54yb0sc654/%@/%@",[self.downloadedCarRecord carid],[self.downloadedCarRecord phone],retrieveduuid,brandID];
...
#warning Modified New web service_17/06/2014 Check feature(GetCarFeatures
    ...
    NSString *featuresServiceStr=[NSString stringWithFormat:@"http://test1.unitedcarexchange.com/MobileService/GenericServices.svc/GenericGetCarFeatures/%d/ds3lkDFD1F5fFGnf2daFs45REsd6re54yb0sc654/%@/",[self.downloadedCarRecord carid],retrieveduuid];
...
# warning Modified New web service_17/06/2014 FindCarID(gallery)
    ...
    NSString *brandID = @"2";
    NSString *webServiceUrl=[NSString stringWithFormat:@"http://test1.unitedcarexchange.com/MobileService/GenericServices.svc/GenericFindCarID/%d/ds3lkDFD1F5fFGnf2daFs45REsd6re54yb0sc654/%@/%@",[self.downloadedCarRecord carid],retrieveduuid,brandID];
