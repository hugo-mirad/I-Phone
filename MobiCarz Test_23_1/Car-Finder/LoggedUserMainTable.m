...
- (void)retrievePackageDetails:(NSString *)uid
{
    ...
    NSString *brandID = @"2";
     ...
     NSString *packageDetailsServiceStr=[NSString stringWithFormat:@"http://test1.unitedcarexchange.com/MobileService/GenericServices.svc/GenericGetPackageDetailsByUID/%@/ds3lkDFD1F5fFGnf2daFs45REsd6re54yb0sc654/%@/%@/%@", uid,retrieveduuid,sessionID,brandID] ;
    ...
    [operation setCompletionBlockWithSuccess:^(AFHTTPRequestOperation *operation, id responseObject) {
        ...
        if(error2==nil)
        {
            ...
            NSArray *packagesResultArray=[wholeResult objectForKey:@"GenericGetPackageDetailsByUIDResult"];
