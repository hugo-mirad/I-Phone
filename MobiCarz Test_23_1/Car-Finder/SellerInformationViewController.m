...
-(void)callUpdateSellerInfoServiceWithSellerID:(NSString *)sellerId sellerName:(NSString *)sellerName city:(NSString *)city state:(NSString *)stateCode zip:(NSString *)zip phone:(NSString *)phone email:(NSString *)email carId:(NSString *)carId
{
    ...
    parameters = [NSDictionary dictionaryWithObjectsAndKeys:sellerId,@"sellerID",sellerName,@"sellerName",city,@"city",stateCode,@"state",zip,@"zip",phone,@"phone",email,@"email",carId,@"carID",uID,@"UID",@"ds3lkDFD1F5fFGnf2daFs45REsd6re54yb0sc654",@"AuthenticationID",retrieveduuid,@"CustomerID",sessionID1,@"SessionID",brandID,@"BrandID",nil];
  
    __weak SellerInformationViewController *weakSelf=self;
    
    [Client setParameterEncoding:AFJSONParameterEncoding];
    [Client postPath:@"MobileService/GenericCarService.asmx/GenericUpdateSellerInformation" parameters:parameters success:^(AFHTTPRequestOperation *operation, id responseObject)
     {
         [[UIApplication sharedApplication] setNetworkActivityIndicatorVisible:NO];
...
-(void)retrieveLoggedUserPreviousData
{
    ...
    if (self.carReceived) {
        ...
        if ([stateStr isEqualToString:@"Unspecified"]) {
            stateStr = @"UN";
        }
