...
#warning  changed images web service
        
//http://images.mobicarz.com/
        ///
        NSString *completeimagename1=nil;
        //condition to check whether PICLOC0 is empty or not
        if (![[tempDict objectForKey:@"_PICLOC0"] isEqualToString:@"Emp"] || ![[tempDict objectForKey:@"_PICLOC0"] isEqualToString:@""]) {
            completeimagename1=[[NSString alloc]initWithFormat:@"http://images.mobicarz.com/%@/%@",[tempDict objectForKey:@"_PICLOC0"],[tempDict objectForKey:@"_PIC0"]];
        ...
        {
            completeimagename1=[NSString stringWithFormat:@"http://images.mobicarz.com/%@",[tempDict objectForKey:@"_PIC0"]];
