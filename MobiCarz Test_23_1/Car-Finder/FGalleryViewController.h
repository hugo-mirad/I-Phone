...
@property (assign) BOOL viewFromGalleryWithLoginSection,selectedToGalleryViewFromLoginViews;


@property (strong,nonatomic) CarRecord *carRecord;

@property (nonatomic,retain) UIToolbar *toolbarTitle;

@property(assign,nonatomic) BOOL justUploaded;
