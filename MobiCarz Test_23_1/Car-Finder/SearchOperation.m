...
#warning modified web service _ 17/06/2014
NSString *brandID = @"2";
     NSString *webServiceUrl=[NSString stringWithFormat:@"http://test1.unitedcarexchange.com/MobileService/GenericServices.svc/GnericGetCarsSearchJSON/%@/%@/%@/%@/%d/18/Price/ds3lkDFD1F5fFGnf2daFs45REsd6re54yb0sc654/%@/%@",someMakeNameReceived,someModelNameReceived,someZipReceived,someMilesReceived,somePageNo,retrieveduuid,brandID];
...
-(void)connectionDidFinishLoading:(NSURLConnection *)connection
{
    ...
    NSArray *getCarsSearchJSONResult=[wholeResult objectForKey:@"GnericGetCarsSearchJSONResult"];
