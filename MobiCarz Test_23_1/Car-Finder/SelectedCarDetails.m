...
# warning Modified New web service_17/06/2014 FindCarID(gallery)
    ...
    NSString *brandID = @"2";
    NSString *webServiceUrl=[NSString stringWithFormat:@"http://test1.unitedcarexchange.com/MobileService/GenericServices.svc/GenericFindCarID/%d/ds3lkDFD1F5fFGnf2daFs45REsd6re54yb0sc654/%@/%@",[self.carReceived carid],retrieveduuid,brandID];
...
#warning here added new images link
...
#warning Modified New web service_17/06/2014 Check feature(GetCarFeatures
    ...
    NSString *featuresServiceStr=[NSString stringWithFormat:@"http://test1.unitedcarexchange.com/MobileService/GenericServices.svc/GenericGetCarFeatures/%d/ds3lkDFD1F5fFGnf2daFs45REsd6re54yb0sc654/%@/",[self.carReceived carid],retrieveduuid];
...
- (void)callWebServiceToSaveData:(NSInteger)buttonIndex
{
    ...
    NSString *brandID = @"2";
     ...
     NSString *updateCarDetailsServiceStr=[NSString stringWithFormat:@"http://test1.unitedcarexchange.com/MobileService/GenericServices.svc/GenericUpdateMobileCarStatusByCarID/%d/%@/%@/ds3lkDFD1F5fFGnf2daFs45REsd6re54yb0sc654/%@/%@/%@", [self.carReceived carid],uid,self.statusSelected,retrieveduuid,sessionID,brandID];
...
- (void)webServiceCallToSaveDataSucceededWithResponse:(NSDictionary *)aDict
{
    ...
    if ([[aDict objectForKey:@"GenericUpdateMobileCarStatusByCarIDResult"] isEqualToString:@"Success"]) {
    ...
    else if ([[aDict objectForKey:@"GenericUpdateMobileCarStatusByCarIDResult"] isEqualToString:@"Session timed out"])
    {
    ...
    else if ([[aDict objectForKey:@"GenericUpdateMobileCarStatusByCarIDResult"] isEqualToString:@"Unsucess"]||[[aDict objectForKey:@"GenericUpdateMobileCarStatusByCarIDResult"] isEqualToString:@"Failed"])
    {
...
- (void)logoutButtonTapped:(id)sender
{
    ...
    NSString *logoutServiceStr=[NSString stringWithFormat:@"http://test1.unitedcarexchange.com/MobileService/GenericServices.svc/GenericPerformLogoutMobile/%@/%@/ds3lkDFD1F5fFGnf2daFs45REsd6re54yb0sc654/%@/%@", uid,sessionID,retrieveduuid,brandID] ; //]@"din9030231534",@"dinesh"];
