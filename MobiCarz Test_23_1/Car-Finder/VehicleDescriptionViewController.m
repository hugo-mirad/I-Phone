...
//        self.navigationItem.leftBarButtonItem=button;
    ...
    [self.view addConstraints:[NSLayoutConstraint constraintsWithVisualFormat:@"|[descScrollView]|" options:0 metrics:0 views:viewsDict]];
     ...
     if (floor(NSFoundationVersionNumber) <= NSFoundationVersionNumber_iOS_6_1){
         ...
         [self.view addConstraints:[NSLayoutConstraint constraintsWithVisualFormat:@"V:|-60-[descScrollView]|" options:0 metrics:0 views:viewsDict]];
     }
