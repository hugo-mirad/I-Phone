...
#warning check App runing condition
    ...
    parameters = [NSDictionary dictionaryWithObjectsAndKeys:name,@"name",address,@"address",city,@"city",stateID,@"stateID",zip,@"zip",phoneNo,@"phone",uid,@"UID",companyName,@"businessName",altEmail,@"altEmail",altPhoneNo,@"altPhone",@"ds3lkDFD1F5fFGnf2daFs45REsd6re54yb0sc654",@"AuthenticationID",retrieveduuid,@"CustomerID",sessionID,@"SessionID",brandID, @"BrandID",nil];
    ...
    [self.Client postPath:@"MobileService/GenericCarService.asmx/GenericUpdateUserRegistration" parameters:parameters success:^(AFHTTPRequestOperation *operation, id responseObject) {
...
-(void)parserDidEndDocument:(NSXMLParser *)parser
{
    ...
    NSLog(@"[self.currentElementChar--%@",self.currentElementChars);
