...
{
    //GetModelsInfo
 //   http://www.unitedcarexchange.com/MobileService/ServiceMobile.svc/GetModelsInfo/ds3lkDFD1F5fFGnf2daFs45REsd6re54yb0sc654/12345 
    
    
    
     NSString *retrieveduuid = [SSKeychain passwordForService:UUID_USER_DEFAULTS_KEY account:@"user"];
    
    NSString *urlStr = [NSString stringWithFormat:@"http://www.unitedcarexchange.com/MobileService/ServiceMobile.svc/GetModelsInfo/ds3lkDFD1F5fFGnf2daFs45REsd6re54yb0sc654/%@",retrieveduuid];
    
    
    NSURL *url = [NSURL URLWithString:urlStr];
    
    
   // NSURL *url = [NSURL URLWithString:@"http://unitedcarexchange.com/MobileService/Service.svc/GetModelsInfo/"];
