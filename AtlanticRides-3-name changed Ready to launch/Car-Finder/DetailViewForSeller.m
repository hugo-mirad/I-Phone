...
- (void)editBtnTapped
{
    ...
    /*
     ...
     SelectedCarDetails *selectedCarDetails = [storyboard instantiateViewControllerWithIdentifier:@"SelectedCarDetailsID"];
     
     selectedCarDetails.carReceived=self.carRecordFromFirstView;
     
     // SelectedCarDetails *selectedCarDetails=[storyboard instantiateViewControllerWithIdentifier:@"SelectedCarDetailsId"];
     //selectedCarDetails.carReceived=self.carRecordFromFirstView;
     UINavigationController *cntrol = [[UINavigationController alloc] initWithRootViewController:selectedCarDetails];
...
- (void)viewDidLoad
{
    ...
    //
    UIBarButtonItem *rb=[[UIBarButtonItem alloc] initWithTitle:@"Edit" style:UIBarButtonItemStyleBordered target:self action:@selector(editBtnTapped)];
...
- (BOOL)shouldAutorotateToInterfaceOrientation:(UIInterfaceOrientation)interfaceOrientation
{
    ...
    {
        self.label1.frame = CGRectMake(10.0f,598+32,self.view.frame.size.width-10,9999);  //your landscape frame
       
    }
    else
    {
        self.label1.frame = CGRectMake(10.0f, 598+32, self.view.frame.size.width-10, 9999); // your portrait frame
                                          ...
                                          duration:(NSTimeInterval)duration
{
    ...
    {
        self.label1.frame = CGRectMake(10.0f,598+32,self.view.frame.size.width-10,descLabelHeight);  //your landscape frame
        
    }
    else
    {
        self.label1.frame = CGRectMake(10.0f, 598+32, self.view.frame.size.width-10, descLabelHeight); // your portrait frame
...
- (void)displayContent
{
    ...
    CameraViewController *cvController=[loginStoryboard instantiateViewControllerWithIdentifier:@"CameraViewControllerId"];
    ...
    noteLblValue.textColor=[UIColor whiteColor];
