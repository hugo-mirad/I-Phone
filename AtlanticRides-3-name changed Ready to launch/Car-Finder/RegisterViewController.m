...
- (void)viewDidLoad
{
    ...
    
    {
        ...
        confirmEmailLabel.textColor = [UIColor whiteColor];
       ...
       // [self.registerButton setBackgroundImage:[UIImage imageNamed:@"Register.png"] forState:UIControlStateNormal];
        ...
        self.registerButton.backgroundColor = [UIColor colorWithRed:2.0f/255.0f green:152.0f/255.0f blue:215.0f/255.0f alpha:1.0f];
        ...
        self.registerButton.layer.shadowRadius = 2.0f;
...
- (void)registerNewUserWithFname:(NSString *)name phone:(NSString *)phone email:(NSString *)email
{
    ...
    NSLog(@"newRegistrationServiceStr=%@",newRegistrationServiceStr);
    //calling service
    ...
    [operation setCompletionBlockWithSuccess:^(AFHTTPRequestOperation *operation, id responseObject) {
        ...
        if(error2==nil)
        {
            ...
            if (!newRegistrationResult) {
                ...
                UIAlertView *alert=[[UIAlertView alloc]initWithTitle:@"Error" message:@"UCE Car Finder could not connect to the server." delegate:nil cancelButtonTitle:@"OK" otherButtonTitles:nil, nil];
                [alert show];
                alert=nil;
            ...
            {
                //success.
                NSLog(@"newRegistrationResult=%d",newRegistrationResult);
