...
- (void)viewDidLoad
{
    ...
    if (floor(NSFoundationVersionNumber) <= NSFoundationVersionNumber_iOS_6_1){
        ...
        navtitle.textColor=[UIColor  colorWithRed:74.0f/255.0f green:68.0f/255.0f blue:105.0f/255.0f alpha:1.0f];
   ...
   // self.mileageTextField.inputAccessoryView = toolbarForPicker;
    ...
    [self.addNewCarButton setTitleColor:[UIColor blackColor] forState:UIControlStateNormal];
    [self.addNewCarButton setTitleColor:[UIColor redColor] forState:UIControlStateHighlighted];
    self.addNewCarButton.backgroundColor = [UIColor colorWithRed:241.0f/255.0f green:240.0f/255.0f blue:240.0f/255.0f alpha:1.0f];
