    ...
    if (self) {
        ...
        if (![[tempDict objectForKey:@"_PICLOC0"] isEqualToString:@"Emp"]) {
           // completeimagename1=[[NSString alloc]initWithFormat:@"http://www.unitedcarexchange.com/%@/%@",[tempDict objectForKey:@"_PICLOC0"],[tempDict objectForKey:@"_PIC0"]];
            completeimagename1=[[NSString alloc]initWithFormat:@"http://images.unitedcarexchange.com/%@/%@",[tempDict objectForKey:@"_PICLOC0"],[tempDict objectForKey:@"_PIC0"]];
        ...
        else if ([[tempDict objectForKey:@"_PICLOC0"] isEqualToString:@"Emp"])
        {
            ...
            completeimagename1=[NSString stringWithFormat:@"http://images.unitedcarexchange.com/%@",[tempDict objectForKey:@"_PIC0"]];
