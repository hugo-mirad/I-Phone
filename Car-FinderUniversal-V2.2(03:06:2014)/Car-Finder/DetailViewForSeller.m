                                          ...
                                          duration:(NSTimeInterval)duration
{
    ...
    {
        self.label1.frame = CGRectMake(10.0f,650+32,self.view.frame.size.width-10,descLabelHeight);  //your landscape frame
        
    }
    else
    {
        self.label1.frame = CGRectMake(10.0f, 650+32, self.view.frame.size.width-10, descLabelHeight); // your portrait frame
