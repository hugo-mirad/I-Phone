...
- (void)viewDidLoad
{
    ...
    [self.uploadButton setTitleColor:[UIColor colorWithRed:105.0f/255.0f green:90.0f/255.0f blue:85.0f/255.0f alpha:1.0f] forState:UIControlStateNormal];
...
//    [self.Client postPath:@"MobileService/CarService.asmx/UploadPictureByCarID" parameters:parameters success:^(AFHTTPRequestOperation *operation, id responseObject) {
    ...
    [self.Client postPath:@"MobileService/CarService.asmx/UploadPictureByCarIDNew" parameters:parameters success:^(AFHTTPRequestOperation *operation, id responseObject)
     {
