...
- (void)viewDidLoad
{
    ...
    askPriceLabel.textColor=[UIColor whiteColor];
    ...
    exteriorColorLabel.textColor=[UIColor whiteColor];
    ...
    interiorColorLabel.textColor=[UIColor whiteColor];
    ...
    transmissionLabel.textColor=[UIColor whiteColor];
    ...
    driveTrainLabel.textColor=[UIColor whiteColor];
    ...
    engineCylindersLabel.textColor=[UIColor whiteColor];
    ...
    doorsLabel.textColor=[UIColor whiteColor];
    ...
    fuelTypeLabel.textColor=[UIColor whiteColor];
...
- (void) pickerView:(UIPickerView *)pickerView didSelectRow:(NSInteger)row inComponent:(NSInteger)component
{
    if ([self.exteriorColorPicker isEqual:pickerView])
    {
        ...
        //
        //        NSLog(@"%@ ",self.exteriorColorTextField.text);
...
-(void)exteriorColorDoneButtonTapped
{
    ...
    NSLog(@"Your are pressed Done Button");
}
...
- (void)enableDisableFields:(BOOL)enable
{
    ...
    else
    {
        ...
        self.askPriceTextField.textColor = [UIColor whiteColor];
        self.askPriceTextField.backgroundColor=[UIColor clearColor];
        ...
        self.exteriorColorTextField.textColor = [UIColor whiteColor];
        self.exteriorColorTextField.backgroundColor=[UIColor clearColor];
        
        self.interiorColorTextField.userInteractionEnabled=NO;
        self.interiorColorTextField.textColor = [UIColor whiteColor];
        self.interiorColorTextField.backgroundColor=[UIColor clearColor];
        
        self.transmissionTextField.enabled=NO;
        self.transmissionTextField.textColor = [UIColor whiteColor];
        self.transmissionTextField.backgroundColor=[UIColor clearColor];
        
        self.conditionTextField.enabled=NO;
        self.conditionTextField.textColor = [UIColor whiteColor];
        self.conditionTextField.backgroundColor=[UIColor clearColor];
        
        self.driveTrainTextField.enabled=NO;
        self.driveTrainTextField.textColor = [UIColor whiteColor];
        self.driveTrainTextField.backgroundColor=[UIColor clearColor];
        
        self.engineCylindersTextField.enabled=NO;
        self.engineCylindersTextField.textColor = [UIColor whiteColor];
        self.engineCylindersTextField.backgroundColor=[UIColor clearColor];
        
        self.doorsTextField.userInteractionEnabled=NO;
        self.doorsTextField.textColor = [UIColor whiteColor];
        self.doorsTextField.backgroundColor=[UIColor clearColor];
        
        self.fuelTypeTextField.enabled=NO;
        self.fuelTypeTextField.textColor = [UIColor whiteColor];
        self.fuelTypeTextField.backgroundColor=[UIColor clearColor];
        
        self.vinTextField.enabled=NO;
        self.vinTextField.textColor = [UIColor whiteColor];
        self.vinTextField.backgroundColor=[UIColor clearColor];
...
- (BOOL)userMadeChanges
{
    ...
    NSLog(@"titleNotChanged=%d priceNotChanged=%d mileageNotChanged=%d exteriorColorNotChanged=%d interiorColorNotChanged=%d transmissionNotChanged=%d conditionNotChanged=%d driveTrainNotChanged=%d engineCylindersNotChanged=%d numberOfDoorsNotChanged=%d fueltypeNotChanged=%d vinNotChanged=%d",titleNotChanged, priceNotChanged, mileageNotChanged, exteriorColorNotChanged, interiorColorNotChanged, transmissionNotChanged, conditionNotChanged, driveTrainNotChanged, engineCylindersNotChanged, numberOfDoorsNotChanged, fueltypeNotChanged, vinNotChanged);
...
- (void)callWebServiceToSaveData
{
    ...
    /*
     ...
     NSLog(@"[self.fuelTypeIdsArray objectAtIndex:row] == %@",[self.fuelTypeIdsArray objectAtIndex:row]);
...
- (void)keyboardDidHide:(id)sender
{
    ...
    if (![self firstResponderFound]) {
        //NSLog(@"[self firstResponderFound] is nill");
