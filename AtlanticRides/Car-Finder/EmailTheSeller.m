...
-(void)addcontroles
{
    TPKeyboardAvoidingScrollView *detailScrollView=[[TPKeyboardAvoidingScrollView alloc] initWithFrame:CGRectMake(0, 0, self.view.frame.size.width, self.view.frame.size.height)];
   ...
   detailScrollView.scrollEnabled=YES;
    ...
    //  fNameTextField.delegate = self;
        ...
        self.sendButton.backgroundColor = [UIColor colorWithRed:2.0f/255.0f green:152.0f/255.0f blue:215.0f/255.0f alpha:1.0f];//[UIColor colorWithRed:226.0f/255.0f green:2.0f/255.0f blue:4.0f/255.0f alpha:1.0f];
        [self.sendButton setTitle:@"Send" forState:UIControlStateNormal];
        [self.sendButton setTitleColor:[UIColor whiteColor] forState:UIControlStateNormal];
        //Button with 0 border so it's shape like image shape
        self.sendButton.layer.shadowRadius = 2.0f;
        ...
        self.cancelButton.backgroundColor = [UIColor colorWithRed:213.0f/255.0f green:141.0f/255.0f blue:0.0f/255.0f alpha:1.0f];//[UIColor colorWithRed:241.0f/255.0f green:240.0f/255.0f blue:240.0f/255.0f alpha:1.0f];
    ...
    [detailScrollView setContentSize:CGSizeMake(self.view.frame.size.width,600)];
        ...
        self.sendButton.backgroundColor = [UIColor colorWithRed:2.0f/255.0f green:152.0f/255.0f blue:215.0f/255.0f alpha:1.0f];
        [self.sendButton setTitle:@"Send" forState:UIControlStateNormal];
        [self.sendButton setTitleColor:[UIColor whiteColor] forState:UIControlStateNormal];
        //Button with 0 border so it's shape like image shape
        self.sendButton.layer.shadowRadius = 2.0f;
        ...
        self.cancelButton.backgroundColor = [UIColor colorWithRed:213.0f/255.0f green:141.0f/255.0f blue:0.0f/255.0f alpha:1.0f];
        [self.cancelButton setTitle:@"Cancel" forState:UIControlStateNormal];
        [self.cancelButton setTitleColor:[UIColor whiteColor] forState:UIControlStateNormal];
        //Button with 0 border so it's shape like image shape
        self.cancelButton.layer.shadowRadius = 2.0f;
...
-(void)callEmailServiceWith:(NSString *)buyerEmailAddress buyerPhoneNumber:(NSString *)buyerPhoneNumber city:(NSString *)city fName:(NSString *)fName lName:(NSString *)lName comments:(NSString *)msg
{
    ...
    // NSArray *values=[NSArray arrayWithObjects:buyerEmail,buyerCity,buyerPhone,buyerFirstName,buyerLastName,buyerComments,ipAddress,sellerphone,sellerprice,carid,sYear,make,model,price,@"arundarla@datumglobal.net", @"ds3lkDFD1F5fFGnf2daFs45REsd6re54yb0sc654",retrieveduuid,nil];
