...
- (void)viewDidLoad
{
    ...
    self.phoneNoTextField.textColor=[UIColor whiteColor];
    ...
    altphoneNoLabel.textColor=[UIColor whiteColor];
    ...
    altEmailLabel.textColor=[UIColor whiteColor];
...
- (void)retrieveDataFromDefaults
{
    ...
    NSLog(@"registrationDict--%@",registrationDict);
...
- (void)pickerView:(UIPickerView *)pickerView didSelectRow:(NSInteger)row inComponent:(NSInteger)component
{
    if ([pickerView isEqual:self.statePicker]) {
        ...
        NSLog(@"self.stateIdSelected=%@-%@",self.stateIdSelected,stateName);
    }
}
...
- (void)callRegistrationServiceWithName:(NSString *)name address:(NSString *)address city:(NSString *)city state:(NSString *)stateID zip:(NSString *)zip phoneNumber:(NSString *)phoneNo uid:(NSString *)uid companyName:(NSString *)companyName altEmail:(NSString *)altEmail altPhoneNumber:(NSString *)altPhoneNo
{
    ...
    NSLog(@"name = %@,address = %@,city = %@,state = %@,zip = %@,phoneNo = %@,uid = %@,companyName = %@,altEmail = %@,altPhoneNo = %@",name,address,city,stateID,zip,phoneNo,uid,companyName,altEmail,altPhoneNo);
...
- (void)enableDisableFields:(BOOL)enable
{
    ...
    else
    {
        ...
        self.comapanyNameTextField .textColor = [UIColor whiteColor];
        self.comapanyNameTextField.backgroundColor=[UIColor clearColor];
        
        self.altPhoneNoTextField.enabled=NO;
        self.altPhoneNoTextField.textColor = [UIColor whiteColor];
        self.altPhoneNoTextField.backgroundColor=[UIColor clearColor];
        ...
        self.altEmailTextField.textColor = [UIColor whiteColor];
        self.altEmailTextField.backgroundColor=[UIColor clearColor];
        ...
        self.stateTextField.textColor = [UIColor whiteColor];
        self.stateTextField.backgroundColor = [UIColor clearColor];
...
- (BOOL)userMadeChanges
{
    ...
    //NSLog(@"self.stateIdSelected=%@stateid from dict=%@AAAA class of self.stateIdSelected=%@ class fo stateid from dict=%@",self.stateIdSelected,[registrationDict objectForKey:@"StateID"],NSStringFromClass([self.stateIdSelected class]),NSStringFromClass([[registrationDict objectForKey:@"StateID"] class]));
   ...
   // NSLog(@"nameNotChanged=%d phoneNoNotChanged=%d altPhoneNotChanged=%d cityNotChanged=%d companyNameNotChanged=%d stateCodeNotChanged=%d emailNotChanged=%d altEmailNotChanged=%d addressNotChanged=%d zipNotChanged=%d",nameNotChanged, phoneNoNotChanged, altPhoneNotChanged, cityNotChanged, companyNameNotChanged, stateCodeNotChanged, emailNotChanged, altEmailNotChanged, addressNotChanged, zipNotChanged);
