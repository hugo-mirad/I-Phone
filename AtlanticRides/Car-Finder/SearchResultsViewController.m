...
-(UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if([[srccInfo car] carid])
    {
        ...
        else
        {
            ...
            //           NSLog(@"image should be downloaded for %@ - %@ - %d image=%@",srccInfo.car1.make,srccInfo.car1.model,srccInfo.car1.price,srccInfo.car1.thumbnailUIImage);
...
- (void)addCarsUsingResultArray:(NSArray *)mArray startingIndexPosition:(NSInteger)startingIndexPosition totalCarsToAdd:(NSInteger)carsToAdd
{
    ...
    //NSLog(@"before adding cars array=%@ count is %d",self.arrayOfAllSearchResultsCustomCellInfoObjects,self.arrayOfAllSearchResultsCustomCellInfoObjects.count);
    [self.arrayOfAllSearchResultsCustomCellInfoObjects addObjectsFromArray:mArray]; /////
    //NSLog(@"after adding cars array=%@ count is %d",self.arrayOfAllSearchResultsCustomCellInfoObjects,self.arrayOfAllSearchResultsCustomCellInfoObjects.count);
    //
...
- (void)deleteCarsFromBottomWithResultArray:(NSArray *)mArray startingIndexPosition:(NSInteger)lastPageStartingIndex totalCarsToDelete:(NSInteger)carsToDelete
{
    ...
    NSLog(@"before deleting from bottom arrayOfAllSearchResultsCustomCellInfoObjects count=%d",self.arrayOfAllSearchResultsCustomCellInfoObjects.count);
    
    [self.arrayOfAllSearchResultsCustomCellInfoObjects removeObjectsAtIndexes:indexSet4];
    NSLog(@"after deleting from bottom arrayOfAllSearchResultsCustomCellInfoObjects count=%d",self.arrayOfAllSearchResultsCustomCellInfoObjects.count);
...
- (void)addCarsAtTopUsingResultArray:(NSArray *)mArray startingIndexPosition:(NSInteger)startingIndexPosition totalCarsToAdd:(NSInteger)carsToAdd
{
    ...
    NSLog(@"before adding at top to arrayOfAllSearchResultsCustomCellInfoObjects count=%d",self.arrayOfAllSearchResultsCustomCellInfoObjects.count);
    [self.arrayOfAllSearchResultsCustomCellInfoObjects insertObjects:mArray atIndexes:indexSetForTopRows];
    NSLog(@"after adding at top to arrayOfAllSearchResultsCustomCellInfoObjects count=%d",self.arrayOfAllSearchResultsCustomCellInfoObjects.count);
