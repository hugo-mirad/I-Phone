...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if ([[prefDict objectForKey:@"name"] isEqualToString:@"Preference0"])
    {
        ...
        addPreferenceBtn.backgroundColor = [UIColor colorWithRed:213.0f/255.0f green:141.0f/255.0f blue:0.0f/255.0f alpha:1.0f];
        [addPreferenceBtn setTitle:@"Add Preferences" forState:UIControlStateNormal];
...
-(void)startPreferenceDownloadOp:(NSMutableDictionary *)prefDict
{
    ...
    [operation setCompletionBlockWithSuccess:^(AFHTTPRequestOperation *operation, id responseObject) {
        ...
        if(error2==nil)
        {
            ...
            NSLog(@"prefCarsArray--%@",prefCarsArray);
