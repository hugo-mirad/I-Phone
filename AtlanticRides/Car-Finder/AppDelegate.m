...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    //increase font size of all tabbar items
    //UITabBarController *tabBarController = (UITabBarController *)self.window.rootViewController;
    //[tabBarController setSelectedIndex:3];
    
    /*
     NSArray *allTabBarItems=tabBarController.tabBar.items;
     for (UITabBarItem *aTab in allTabBarItems) {
     
     //[aTab setTitleTextAttributes:[NSDictionary dictionaryWithObjectsAndKeys:
     [UIColor orangeColor], UITextAttributeTextColor,
     [NSValue valueWithUIOffset:UIOffsetMake(0,0)], UITextAttributeTextShadowOffset,
     [UIFont fontWithName:@"Helvetica" size:13.0],UITextAttributeFont, nil]
    ...
    /*
     ...
     SellerInformationViewController *sellerInformationViewController=[storyboard instantiateViewControllerWithIdentifier:@"VehicleInformationViewControllerID"]; //VehicleInformationViewControllerID //SellerInformationViewControllerId
     self.window.rootViewController=sellerInformationViewController;
     */
