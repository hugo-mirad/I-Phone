...
- (void)viewDidLoad
{
   ...
   self.passwordTextField.text=@"123456";
    ...
    self.loginButton.backgroundColor = [UIColor colorWithRed:213.0f/255.0f green:141.0f/255.0f blue:0.0f/255.0f alpha:1.0f];
    ...
    else
    {
       // LetterParams.DeviceType=2;//IPad Non-Retina
        ...
        //
         NSLayoutConstraint *passwordTextFieldConstraint=[NSLayoutConstraint constraintWithItem:self.passwordTextField attribute:
        NSLayoutAttributeTop relatedBy:NSLayoutRelationEqual toItem:self.userNameTextField attribute:NSLayoutAttributeBottom multiplier:1 constant:14];
        [self.view addConstraint:passwordTextFieldConstraint];
        
        passwordTextFieldConstraint=[NSLayoutConstraint constraintWithItem:self.passwordTextField attribute:NSLayoutAttributeLeading relatedBy:NSLayoutRelationEqual toItem:self.userNameTextField attribute:NSLayoutAttributeLeading multiplier:1 constant:0];
        [self.view addConstraint:passwordTextFieldConstraint];
        //-------------
        passwordTextFieldConstraint=[NSLayoutConstraint constraintWithItem:self.passwordTextField attribute:NSLayoutAttributeTrailing relatedBy:NSLayoutRelationEqual toItem:self.userNameTextField attribute:NSLayoutAttributeTrailing multiplier:1 constant:0];
        [self.view addConstraint:passwordTextFieldConstraint];
        ...
        loginButtonConstraint=[NSLayoutConstraint constraintWithItem:self.loginButton attribute:NSLayoutAttributeHeight relatedBy:NSLayoutRelationEqual toItem:nil attribute:NSLayoutAttributeHeight multiplier:1 constant:32];
        [self.view addConstraint:loginButtonConstraint];
        ...
        [noAccountLabel setFont:[UIFont systemFontOfSize:16]];
        NSLayoutConstraint *noAccountLabelConstraint=[NSLayoutConstraint constraintWithItem:noAccountLabel attribute:NSLayoutAttributeTop relatedBy:NSLayoutRelationEqual toItem:self.loginButton attribute:NSLayoutAttributeBottom multiplier:1 constant:10];
        [self.view addConstraint:noAccountLabelConstraint];
        ...
        noAccountLabelConstraint=[NSLayoutConstraint constraintWithItem:noAccountLabel attribute:NSLayoutAttributeHeight relatedBy:NSLayoutRelationEqual toItem:nil attribute:NSLayoutAttributeHeight multiplier:1 constant:32];
        [self.view addConstraint:noAccountLabelConstraint];

        
        
         NSLayoutConstraint *registerButtonConstraint=[NSLayoutConstraint constraintWithItem:self.registerButton attribute:NSLayoutAttributeTop relatedBy:NSLayoutRelationEqual toItem:self.loginButton attribute:NSLayoutAttributeBottom multiplier:1 constant:12];
        [self.view addConstraint:registerButtonConstraint];
        
        registerButtonConstraint=[NSLayoutConstraint constraintWithItem:self.registerButton attribute:NSLayoutAttributeLeading relatedBy:NSLayoutRelationEqual toItem:noAccountLabel attribute:NSLayoutAttributeTrailing multiplier:1 constant:10];
        [self.view addConstraint:registerButtonConstraint];
        
        registerButtonConstraint=[NSLayoutConstraint constraintWithItem:self.registerButton attribute:NSLayoutAttributeTrailing relatedBy:NSLayoutRelationEqual toItem:self.loginIView attribute:NSLayoutAttributeTrailing multiplier:1 constant:-20];
        [self.view addConstraint:registerButtonConstraint];
        
        registerButtonConstraint=[NSLayoutConstraint constraintWithItem:self.registerButton attribute:NSLayoutAttributeHeight relatedBy:NSLayoutRelationEqual toItem:nil attribute:NSLayoutAttributeHeight multiplier:1 constant:32];
        [self.view addConstraint:registerButtonConstraint];
...
-(void)checkLoginStatus
{
    ...
    NSLog(@"loginServiceStr=%@",loginServiceStr);
...
- (void)processLoginResult:(BOOL)loginResult withUserName:(NSString *)uName andPassword:(NSString *)uPassword loginResult:(NSArray *)resultArray andError:(NSError *)error
{
    //NSLog(@"loginResult=%d",loginResult);
    ...
    [operation setCompletionBlockWithSuccess:^(AFHTTPRequestOperation *operation, id responseObject)
     {
         ...
         if(error2==nil)
         {
             ...
             //NSLog(@"self.regInfoArray =====  %@",regInfoArray);
...
- (void)loadCarIdsFromDict
{
    ...
    //NSString *carIdsStr=@"1902"; //@"321,1902";
    
    self.carIdsArray=[carIdsStr componentsSeparatedByString:@","];
    //NSLog(@"carIdsArray=%@",self.carIdsArray);
    ...
    [operation setCompletionBlockWithSuccess:^(AFHTTPRequestOperation *operation, id responseObject)
     {
         ...
         if(error2==nil)
         {
             ...
             //NSLog(@"carIDResultArray =====  %@",carIDResultArray);
