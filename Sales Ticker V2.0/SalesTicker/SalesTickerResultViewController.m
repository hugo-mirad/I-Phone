...
- (void)viewDidLoad
{
    ...
    self.timerObj = [NSTimer scheduledTimerWithTimeInterval:300 target:self selector:@selector(RefreshButtonPressed) userInfo:nil repeats:YES];
    ...
    dateResultLabel = [[UILabel alloc] initWithFrame:CGRectMake(114, 0, 200, 30)];
    ...
    [self.view addSubview:dateResultLabel];
     ...
     UILabel *centerCodeLabel = [[UILabel alloc] initWithFrame:CGRectMake(6, 40, 105, 30)];
    ...
    centerCodeResultLabel = [[UILabel alloc] initWithFrame:CGRectMake(114, 40, 200, 30)];
    ...
    salesResultLabel = [[UILabel alloc] initWithFrame:CGRectMake(114, 80, 200, 30)];
   ...
   /////Table View Delegate Methods
    ...
    //self.salesValusTableView.separatorStyle = UITableViewCellSeparatorStyleNone;
}
